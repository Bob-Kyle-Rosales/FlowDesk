      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1.5">
            ...
            <Input id="name" placeholder="Full Name" className="h-11 bg-white border-[#C4A882] text-[#1A0E05] placeholder:text-[#B0978A] focus-visible:ring-[#E05A2B]/30" {...register("name")} />
            {errors.name && <p className="text-xs text-destructive">{errors.name.message}</p>}
          </div>
          <div className="space-y-1.5">
            <Label htmlFor="organisationName" className="text-sm font-medium text-[#1A0E05]">Agency name</Label>
            <Input id="organisationName" placeholder="Agency Name" className="h-11 bg-white border-[#C4A882] text-[#1A0E05] placeholder:text-[#B0978A] focus-visible:ring-[#E05A2B]/30" {...register("organisationName")} />
        ...
        <div className="space-y-1.5">
          ...
          <Input id="email" type="email" placeholder="Email Address" className="h-11 bg-white border-[#C4A882] text-[#1A0E05] placeholder:text-[#B0978A] focus-visible:ring-[#E05A2B]/30" {...register("email")} />
          {errors.email && <p className="text-xs text-destructive">{errors.email.message}</p>}
        </div>

        <div className="space-y-1.5">
          <Label htmlFor="password" className="text-sm font-medium text-[#1A0E05]">Password</Label>
          <Input id="password" type="password" placeholder="Password" className="h-11 bg-white border-[#C4A882] text-[#1A0E05] placeholder:text-[#B0978A] focus-visible:ring-[#E05A2B]/30" {...register("password")} />
          {errors.password ? (
